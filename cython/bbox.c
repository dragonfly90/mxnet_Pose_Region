...
static const char __pyx_k_data_guest_users_liangdong_lian[] = "/data/guest_users/liangdong/liangdong/practice_demo/mxnet_Pose_Combination/mxnet_Realtime_Multi-Person_Pose_Estimation/cython/bbox.pyx";
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_data_guest_users_liangdong_lian, __pyx_n_s_bbox_overlaps_cython, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
